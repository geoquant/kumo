...
export function dialogVariants({
  ...
  return cn(
    // Base styles
    "shadow-m bg-kumo-base text-kumo-default fixed top-1/2 left-1/2 w-full max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-xl duration-150 data-ending-style:scale-90 data-ending-style:opacity-0 data-starting-style:scale-90 data-starting-style:opacity-0 sm:w-auto sm:max-w-[calc(100vw-3rem)]",
...
function DialogContent({
  ...
  return (
    <DialogBase.Portal>
      <DialogBase.Backdrop className="bg-kumo-overlay fixed inset-0 opacity-80 transition-all duration-150 data-ending-style:opacity-0 data-starting-style:opacity-0" />
      <Surface
        as={DialogBase.Popup}
