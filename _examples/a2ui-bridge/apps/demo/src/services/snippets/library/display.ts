...
export const headingSnippet: Snippet = {
  ...
  name: "Heading Text",
  description:
    "A large page title or main heading. Use for the primary title at the top of a card or page.",
  category: "display",
...
export const sectionHeadingSnippet: Snippet = {
  ...
  description:
    'A bold section header to divide content into logical groups. Use for "Trip Details", "Preferences", "Settings" etc.',
  category: "display",
...
export const badgeSnippet: Snippet = {
  ...
  name: "Status Badge",
  description:
    "A status indicator badge. Use for labels, tags, status indicators.",
  category: "display",
  ...
  slots: [
    { name: "text", type: "string", required: true, description: "Badge text" },
    {
      ...
      type: "string",
      default: "primary",
      description: "Variant: primary, success, warning, danger, neutral",
    },
  ],
  template: {
...
export const avatarSnippet: Snippet = {
  ...
  name: "Avatar",
  description:
    "A user avatar/profile image placeholder. Use for user representation.",
  category: "display",
...
export const amountDisplaySnippet: Snippet = {
  ...
  name: "Amount Display",
  description:
    "A large currency/amount display. Use for totals, balances, prices.",
  category: "display",
  ...
  slots: [
    ...
    },
    {
      name: "label",
      type: "string",
      description: "Optional label below amount",
    },
  ],
  template: {
    componentIds: [
...
export const alertSnippet: Snippet = {
  ...
  name: "Alert Message",
  description:
    "An alert/notification message. Use for warnings, info, success messages.",
  category: "display",
  tags: [
    "alert",
    "notification",
    ...
    components: [
      {
        ...
        props: {
          ...
          description: { literalString: "{{message}}" },
...
export const statCardSnippet: Snippet = {
  ...
  description:
    "A prominent statistic with label and optional badge. Great for dashboards, summaries.",
  category: "display",
  ...
  slots: [
    ...
    },
    {
      name: "badge",
      type: "string",
      description: 'Optional badge text (e.g., "+12%")',
    },
  ],
  template: {
    componentIds: [
...
export const heroHeaderSnippet: Snippet = {
  ...
  name: "Hero Header",
  description:
    "A prominent header with title, subtitle, and optional context. Use at the top of cards/pages.",
  category: "display",
  ...
  slots: [
    ...
    { name: "subtitle", type: "string", description: "Supporting text" },
    {
      name: "context",
      type: "string",
      description: "Small context text above title",
    },
  ],
  template: {
    componentIds: [
...
export const contactHeaderSnippet: Snippet = {
  ...
  name: "Contact Header",
  description:
    "A user/contact display with avatar and name. Great for recipient selection.",
  category: "display",
  ...
  slots: [
    ...
    },
    {
      name: "subtitle",
      type: "string",
      description: "Subtitle like email or phone",
    },
  ],
  template: {
    componentIds: [
...
export const infoRowSnippet: Snippet = {
  ...
  name: "Info Row",
  description:
    "A horizontal row with icon-like indicator and text. Good for feature lists, benefits.",
  category: "display",
  ...
  slots: [
    {
      ...
      type: "string",
      default: "•",
      description: "Icon/bullet character",
    },
    {
      name: "text",
      type: "string",
